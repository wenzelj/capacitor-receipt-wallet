  ...
  <body class="bg-gray-100 font-sans">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
      <div class="flex justify-around">
        ...
        <button data-page="search" class="nav-btn flex flex-col items-center p-2 text-gray-500 hover:text-blue-600 w-full">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
          <span class="text-xs">Search</span>
        </button>
        <button data-page="settings" class="nav-btn flex flex-col items-center p-2 text-gray-500 hover:text-blue-600 w-full">
